...
var fetchPosts = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, axios_1.default.get('https://myankle.co.uk/wp-json/wp/v2/posts?page=0&per_page=100', {
...
posts.forEach(function (post) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        slug = post.slug;
        console.log("/".concat(slug, "/ /blog/").concat(slug, " 301!"));
        // safe file
        fs.writeFileSync("./migration/redirects/".concat(slug, ".js"), "/".concat(slug, "/ /blog/").concat(slug, " 301!"));
        return [2 /*return*/];
    });
}); });
